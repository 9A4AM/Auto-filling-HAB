...
Sub Class_Globals
	...
	Private mCurrentValue As Float = 20
...
Private Sub DrawTicks
	...
	If GaugeType = HALF_CIRCLE Then NumberOfTicks = 20 Else NumberOfTicks = 40
...
Private Sub DrawIndicator (Value As Float)
	...
	mlbl.Text = s & NumberFormat2(Value, 1, 1, 1, True) & SuffixText
