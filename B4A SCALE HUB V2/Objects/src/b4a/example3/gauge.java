...
public class gauge extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example3.gauge");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example3.gauge.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_AnimateValueTo(b4a.example3.gauge parent,float _newvalue) {
this.parent = parent;
this._newvalue = _newvalue;
}
b4a.example3.gauge parent;
float _newvalue;
long _n = 0L;
int _duration = 0;
float _start = 0f;
...
//C
this.state = 1;
 //BA.debugLineNum = 231;BA.debugLine="Dim n As Long = DateTime.Now";
_n = parent.__c.DateTime.getNow();
 //BA.debugLineNum = 232;BA.debugLine="Dim duration As Int = Abs(mCurrentValue - NewValu";
_duration = (int) (parent.__c.Abs(parent._mcurrentvalue-_newvalue)/(double)100*parent._durationfromzeroto100+1000);
 //BA.debugLineNum = 233;BA.debugLine="Dim start As Float = mCurrentValue";
_start = parent._mcurrentvalue;
 //BA.debugLineNum = 234;BA.debugLine="mCurrentValue = NewValue";
parent._mcurrentvalue = _newvalue;
 //BA.debugLineNum = 235;BA.debugLine="Dim tempValue As Float";
_tempvalue = 0f;
 //BA.debugLineNum = 236;BA.debugLine="Do While DateTime.Now < n + duration";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 237;BA.debugLine="tempValue = ValueFromTimeEaseInOut(DateTime.Now";
_tempvalue = parent._valuefromtimeeaseinout((float) (parent.__c.DateTime.getNow()-_n),_start,(float) (_newvalue-_start),_duration);
 //BA.debugLineNum = 238;BA.debugLine="DrawIndicator(tempValue)";
parent._drawindicator(_tempvalue);
 //BA.debugLineNum = 239;BA.debugLine="Sleep(10)";
...
this.state = 4;
;
 //BA.debugLineNum = 240;BA.debugLine="If NewValue <> mCurrentValue Then Return 'will h";
if (true) break;
...
_indicatorbasewidth = 0f;
 //BA.debugLineNum = 27;BA.debugLine="Private mCurrentValue As Float = 20";
_mcurrentvalue = (float) (20);
...
public b4a.example3.gauge._gaugerange  _createrange(float _lowvalue,float _highvalue,int _color) throws Exception{
b4a.example3.gauge._gaugerange _r = null;
 //BA.debugLineNum = 212;BA.debugLine="Public Sub CreateRange(LowValue As Float, HighValu";
 //BA.debugLineNum = 213;BA.debugLine="Dim r As GaugeRange";
_r = new b4a.example3.gauge._gaugerange();
 //BA.debugLineNum = 214;BA.debugLine="r.Initialize";
_r.Initialize();
 //BA.debugLineNum = 215;BA.debugLine="r.LowValue = LowValue";
_r.LowValue /*float*/  = _lowvalue;
 //BA.debugLineNum = 216;BA.debugLine="r.HighValue = HighValue";
_r.HighValue /*float*/  = _highvalue;
 //BA.debugLineNum = 217;BA.debugLine="r.Color = Color";
_r.Color /*int*/  = _color;
 //BA.debugLineNum = 218;BA.debugLine="Return r";
if (true) return _r;
...
b4a.example3.gauge._gaugerange _gr = null;
...
_gr = (b4a.example3.gauge._gaugerange)(group9.Get(index9));
...
String _s = "";
 //BA.debugLineNum = 174;BA.debugLine="Private Sub DrawIndicator (Value As Float)";
 //BA.debugLineNum = 175;BA.debugLine="cvsIndicator.ClearRect(cvsIndicator.TargetRect)";
_cvsindicator.ClearRect(_cvsindicator.getTargetRect());
 //BA.debugLineNum = 176;BA.debugLine="Dim angle As Float = ValueToAngle(Value)";
_angle = _valuetoangle(_value);
 //BA.debugLineNum = 177;BA.debugLine="Dim p As B4XPath";
_p = new anywheresoftware.b4a.objects.B4XCanvas.B4XPath();
 //BA.debugLineNum = 178;BA.debugLine="p.Initialize(x + IndicatorBaseWidth * SinD(angle)";
_p.Initialize((float) (_x+_indicatorbasewidth*__c.SinD(_angle)),(float) (_y-_indicatorbasewidth*__c.CosD(_angle)));
 //BA.debugLineNum = 179;BA.debugLine="Dim length As Float = Radius - 0.3 * IndicatorLen";
_length = (float) (_radius-0.3*_indicatorlength);
 //BA.debugLineNum = 180;BA.debugLine="p.LineTo(x + length * CosD(angle), y + length * S";
_p.LineTo((float) (_x+_length*__c.CosD(_angle)),(float) (_y+_length*__c.SinD(_angle)));
 //BA.debugLineNum = 181;BA.debugLine="p.LineTo(x - IndicatorBaseWidth * SinD(angle), y";
_p.LineTo((float) (_x-_indicatorbasewidth*__c.SinD(_angle)),(float) (_y+_indicatorbasewidth*__c.CosD(_angle)));
 //BA.debugLineNum = 182;BA.debugLine="cvsIndicator.ClipPath(p)";
_cvsindicator.ClipPath(_p);
 //BA.debugLineNum = 183;BA.debugLine="cvsIndicator.DrawRect(cvsIndicator.TargetRect, In";
_cvsindicator.DrawRect(_cvsindicator.getTargetRect(),_indicatorcolor,__c.True,(float) (0));
 //BA.debugLineNum = 184;BA.debugLine="cvsIndicator.RemoveClip";
_cvsindicator.RemoveClip();
 //BA.debugLineNum = 185;BA.debugLine="Dim CircleRadius As Float";
_circleradius = 0f;
 //BA.debugLineNum = 186;BA.debugLine="Dim s As String";
_s = "";
 //BA.debugLineNum = 187;BA.debugLine="If GaugeType = HALF_CIRCLE Then";
if (_gaugetype==_half_circle) { 
 //BA.debugLineNum = 188;BA.debugLine="s = PrefixText.ToUpperCase";
_s = _prefixtext.toUpperCase();
 //BA.debugLineNum = 189;BA.debugLine="CircleRadius =  Radius - IndicatorLength";
_circleradius = (float) (_radius-_indicatorlength);
 }else {
 //BA.debugLineNum = 191;BA.debugLine="CircleRadius = IndicatorBaseWidth";
_circleradius = _indicatorbasewidth;
 };
 //BA.debugLineNum = 193;BA.debugLine="cvsIndicator.DrawCircle(x, y, CircleRadius, Cente";
_cvsindicator.DrawCircle(_x,_y,_circleradius,_centercolor,__c.True,(float) (0));
 //BA.debugLineNum = 194;BA.debugLine="cvsIndicator.Invalidate";
_cvsindicator.Invalidate();
 //BA.debugLineNum = 195;BA.debugLine="mlbl.Text = s & NumberFormat2(Value, 1, 1, 1, Tru";
_mlbl.setText(BA.ObjectToCharSequence(_s+__c.NumberFormat2(_value,(int) (1),(int) (1),(int) (1),__c.True)+_suffixtext));
...
_numberofticks = 0;
 //BA.debugLineNum = 153;BA.debugLine="If GaugeType = HALF_CIRCLE Then NumberOfTicks = 2";
if (_gaugetype==_half_circle) { 
...
_angle = (float) (_i*_anglerange/(double)_numberofticks+_angleoffset);
 //BA.debugLineNum = 157;BA.debugLine="If i Mod 1 = 0 Then";
if (_i%1==0) { 
...
public float  _getcurrentvalue() throws Exception{
 //BA.debugLineNum = 226;BA.debugLine="Public Sub getCurrentValue As Float";
 //BA.debugLineNum = 227;BA.debugLine="Return mCurrentValue";
...
float _newvalue = 0f;
 //BA.debugLineNum = 221;BA.debugLine="Public Sub setCurrentValue (v As Float)";
 //BA.debugLineNum = 222;BA.debugLine="Dim NewValue As Float = Min(MaxValue, Max(MinValu";
_newvalue = (float) (__c.Min(_maxvalue,__c.Max(_minvalue,_v)));
 //BA.debugLineNum = 223;BA.debugLine="AnimateValueTo(NewValue)";
...
b4a.example3.gauge._gaugerange _r = null;
 //BA.debugLineNum = 203;BA.debugLine="Public Sub SetRanges(Ranges As List)";
 //BA.debugLineNum = 204;BA.debugLine="mRanges = Ranges";
_mranges = _ranges;
 //BA.debugLineNum = 205;BA.debugLine="For Each r As GaugeRange In Ranges";
{
...
_r = (b4a.example3.gauge._gaugerange)(group2.Get(index2));
 //BA.debugLineNum = 206;BA.debugLine="r.Color = Bit.And(0x00ffffff, r.Color)";
_r.Color /*int*/  = __c.Bit.And(((int)0x00ffffff),_r.Color /*int*/ );
 //BA.debugLineNum = 207;BA.debugLine="r.Color = Bit.Or(0x88000000, r.Color)";
_r.Color /*int*/  = __c.Bit.Or(((int)0x88000000),_r.Color /*int*/ );
 }
};
 //BA.debugLineNum = 209;BA.debugLine="DrawBackground";
_drawbackground();
...
public float  _valuefromtimeeaseinout(float _time,float _start,float _changeinvalue,int _duration) throws Exception{
 //BA.debugLineNum = 246;BA.debugLine="Private Sub ValueFromTimeEaseInOut(Time As Float,";
 //BA.debugLineNum = 247;BA.debugLine="Time = Time / (Duration / 2)";
_time = (float) (_time/(double)(_duration/(double)2));
 //BA.debugLineNum = 248;BA.debugLine="If Time < 1 Then";
if (_time<1) { 
...
if (true) return (float) (_changeinvalue/(double)2*_time*_time*_time*_time+_start);
 ...
 //BA.debugLineNum = 251;BA.debugLine="Time = Time - 2";
_time = (float) (_time-2);
 //BA.debugLineNum = 252;BA.debugLine="Return -ChangeInValue / 2 * (Time * Time * Time";
...
public float  _valuetoangle(float _value) throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Private Sub ValueToAngle (Value As Float) As Float";
 //BA.debugLineNum = 200;BA.debugLine="Return (Value - MinValue) / (MaxValue - MinValue)";
